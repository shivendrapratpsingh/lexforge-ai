...
// student pay the same. Buying a year does not buy a discount on the
// total; it buys a lower monthly rate, which is why `yearlyPaise` below
// is twelve times the annual monthly rate rather than a percentage off.
//
//   Direct   ₹2,250 / month     ·  ₹2,000 / month billed yearly
//   College  ₹2,000 / student / month  ·  ₹1,800 / student / month billed yearly
//
...
const MONTHLY_RATE        = 225000   // ₹2,250 a month
const YEARLY_MONTHLY_RATE = 200000   // ₹2,000 a month when a year is bought
const SEAT_MONTHLY_RATE   = 200000   // ₹2,000 per student per month
const SEAT_YEARLY_RATE    = 180000   // ₹1,800 per student per month, billed yearly
...
export const PLANS = {
  ...
  yearly: {
    ...
    days: 365,
    blurb: '₹2,000 a month instead of ₹2,250 — paid once for the year.',
  },
}
