...
export const COMPANY = {
  ...
  // The Udyam number is the one registration that already exists, and
  // it is the first thing a college's accounts department asks for.
  udyam: process.env.SELLER_UDYAM || '',
