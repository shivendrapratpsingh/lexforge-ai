...
function courtAddendum(court) {
  ...
  // ── Generic state district / city courts (Maharashtra, Karnataka,
  //    Telangana, Punjab, Kerala, Assam) ──────────────────────────
  const stateMap = {
