...
FORMAL CONSTRUCTIONS: "గౌరవనీయమైన న్యాయస్థానం సమక్షంలో"; "సవినయంగా విన్నవించునది ఏమనగా…"; numbered averments open "అది ఏమనగా…"; "కావున, గౌరవనీయ న్యాయస్థానం దయతో…"; verification: "పైన పేర్కొన్న విషయాలు నా జ్ఞానం మరియు నమ్మకం మేరకు సత్యమని ధృవీకరిస్తున్నాను; ఏ విషయమూ దాచబడలేదు."`,
  kannada: `COURT-KANNADA VOCABULARY: ಅರ್ಜಿ / ಮನವಿ (petition/application); ವಾದಿ–ಪ್ರತಿವಾದಿ (plaintiff–defendant); ಅರ್ಜಿದಾರ–ಪ್ರತಿವಾದಿ (petitioner–respondent); ಆರೋಪಿ (accused); ದೂರುದಾರ (complainant); ಪ್ರಮಾಣ ಪತ್ರ (affidavit); ದೃಢೀಕರಣ (verification); ವಕಾಲತ್ತುನಾಮಾ (vakalatnama); ವಕೀಲರು (advocate); ನ್ಯಾಯಾಲಯ (court); ನೋಟಿಸ್ / ಜಾರಿ (notice/service); ಜಾಮೀನು (bail); ಮೇಲ್ಮನವಿ (appeal); ತೀರ್ಪು / ಆದೇಶ (judgment/order); ತಡೆಯಾಜ್ಞೆ (stay/injunction); ಪ್ರಾರ್ಥನೆ (prayer); ಸಾಕ್ಷಿ (witness); ಸಾಕ್ಷ್ಯ (evidence); ಸ್ವಾಧೀನ (possession); ನಷ್ಟ ಪರಿಹಾರ (damages); ಗುತ್ತಿಗೆ (lease); ಬಾಡಿಗೆದಾರ–ಮಾಲೀಕ (tenant–landlord).
FORMAL CONSTRUCTIONS: address the court as "ಮಾನ್ಯ ನ್ಯಾಯಾಲಯದ ಮುಂದೆ"; numbered averments open "ಅರ್ಜಿದಾರರು ವಿನಂತಿಸುವುದೇನೆಂದರೆ"; prayer opens "ಆದ್ದರಿಂದ ಪ್ರಾರ್ಥಿಸುವುದೇನೆಂದರೆ"; verification: "ಮೇಲೆ ತಿಳಿಸಿದ ವಿಷಯಗಳು ನನ್ನ ಅರಿವಿನ ಮತ್ತು ನಂಬಿಕೆಯ ಪ್ರಕಾರ ಸತ್ಯವಾಗಿವೆ."`,
}
...
export const SUPPORTED_DRAFT_LANGUAGES = ['english', 'hindi', 'bilingual', 'urdu', 'tamil', 'telugu', 'kannada']
