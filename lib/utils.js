...
// SCOPE: Supreme Court + all 25 High Courts (with regional benches) +
// 12 central tribunals + UP / Tamil Nadu / Maharashtra (Mumbai+Pune) /
// Karnataka (Bangalore) / Telangana (Hyderabad) / Punjab / Kerala /
// Assam district courts. Other states' district courts can be added
// to this object without touching any other file.
export const COURTS = {
  // ── Supreme Court ────────────────────────────────────────────
  SUPREME: [
